...
public class RetweetValidator {
    public void nullChekcRetweetId(Integer id) throws ClientException{
        if(id==null){
            throw new ClientException( "Retweet id is required");

        }
    }
   
    public void notnullChekcRetweetId(Integer id ) throws ClientException {
        if(id!=null){
            throw new ClientException( "Retweet id is auto generated, do not input id");
    ...
    public void nullChekcObject( Object o) throws NotFoundException{
        if(o ==null){
            throw new NotFoundException( "Retweet id is not found");

        }
    }
    public void validateRetweetId (Integer id) throws ClientException{
        if (id <= 0){
            throw new ClientException("Retweet id input is invalid");
        }
    }
